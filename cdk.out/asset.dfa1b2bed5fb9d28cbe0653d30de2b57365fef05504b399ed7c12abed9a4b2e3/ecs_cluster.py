...
class EcsClusterStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        #                                                            "assoc1",
        #                                                            route_table_id=route_table.attr_route_table_id,
        #                                                            subnet_id=custom_vpc.select_subnets(subnet_type=ec2.SubnetType.PUBLIC).subnets[0].subnet_id
        ...
        #                                                            "assoc2",
        #                                                            route_table_id=route_table.attr_route_table_id,
        #                                                            subnet_id=custom_vpc.select_subnets(subnet_type=ec2.SubnetType.PUBLIC).subnets[1].subnet_id 
        #                                                         )
        ...
        #                                                            "assoc3",
        #                                                            route_table_id=route_table.attr_route_table_id,
        #                                                            subnet_id=custom_vpc.select_subnets(subnet_type=ec2.SubnetType.PUBLIC).subnets[2].subnet_id
        #                                                         )

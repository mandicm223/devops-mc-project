...
class EcsClusterStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        load_balancer = _elb.NetworkLoadBalancer(self, "MMelasticNetworkLB",
                                vpc=customVPC,
                                internet_facing=True
                                )

        listener = load_balancer.add_listener(self, "mmListenerRule",
                                port=8080
                            )
        
        # security_group_lb = ec2.SecurityGroup("self")